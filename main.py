...
Ya_Bs = '\033[1;34m'
S_aBs = '\033[1;33m'
ab = pyfiglet.figlet_format("Thonxyzz 404")
print(a_bSa + ab)
...
to(
    f"\033[31;m Script Type>> \033[1;36mIp Hacking Thonxyzz404 Tool \n\033[1;31m Telegram >>\033[1;33m@Thonxyzz404\n\033[31;m Creator >>\033[1;33m@THONXYZZ404\n\033[31;m Tool Status >>\033[1;33mWorking\n\033[31;m Tool Value >>\033[1;33mPaid Script\n\033[31;m Time >>\033[1;33m24 Hours\n\033[31;m")
print('')
print('\033[32;m')
import json
import requests
...
def run_banner():
    ...
    stderr.writelines(f"""{Wh}
         .-.
       .'   `.          {Wh}=======================================
       :g g   :       {Wh}| 𝐓𝐡𝐨𝐧𝐱𝐲𝐳𝐳𝟒𝟎𝟒 - TRACKER - IP ADDRESS {Wh}|
       : o    `.      {Wh}|       {Gr}𝐎𝐖𝐍𝐄𝐑 @𝐓𝐡𝐨𝐧𝐱𝐲𝐳𝐳𝟒𝟎𝟒    {Wh}|
      :         ``.   {Wh}=======================================
     :             `.
    :  :         .   `.
    :   :          ` . `.
